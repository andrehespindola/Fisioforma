...
$sql=mysqli_query($conn, "INSERT INTO cinesioterapia (nome, idade, rg, endereco, cidade, estado, da_ta, hora)VALUES('$nome', '$idade', '$rg', '$endereco', '$cidade', '$estado', '$data', '$hora')");
